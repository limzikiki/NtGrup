            ...
            <div each="{ collection, idx in collections }" show="{ ingroup(collection.meta) && infilter(collection.meta) }">
                ...
                <div class="uk-panel uk-panel-box uk-panel-card uk-panel-card-hover">
                    ...
                    <div class="uk-grid uk-grid-small">
                        ...
                        <div class="uk-flex-item-1 uk-text-center uk-text-truncate"><a class="uk-text-bold uk-link-muted" href="<?php $app->route('/collections/entries'); ?>/{collection.name}">{ collection.label }</a></div>

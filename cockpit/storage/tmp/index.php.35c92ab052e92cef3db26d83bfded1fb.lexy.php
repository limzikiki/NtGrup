        ...
        <div class="uk-width-2-3">
            ...
            <div class="uk-grid uk-grid-small uk-flex-middle uk-margin-small-top">
                <div class="uk-flex-item-1">
                    ...
                    <span class="uk-text-small uk-text-danger uk-text-bold uk-text-upper uk-margin-small-top" show="{ keys.master }"><?php echo $app("i18n")->get('Share with caution'); ?></span>
                </div>
                <div if="{keys.master}">
                ...
                <div class="uk-margin uk-flex" each="{setting,idx in keys.special}">
                    <div class="uk-panel uk-panel-box uk-panel-card uk-flex-item-1 uk-margin-right">
                        ...
                        <div class="uk-form-row">
                            <label class="uk-text-small uk-text-bold uk-text-upper"><?php echo $app("i18n")->get('API-Key'); ?></label>

                            <div class="uk-flex uk-flex-middle">
                                <input class="uk-width-1-1 uk-form-large uk-margin-right uk-text-monospace" type="text" placeholder="<?php echo $app("i18n")->get('No key generated'); ?>" bind="keys.special[{idx}].token" readonly>

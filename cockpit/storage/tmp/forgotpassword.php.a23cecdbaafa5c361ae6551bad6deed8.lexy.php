<!doctype html>
<html lang="<?php echo  $app('i18n')->locale ; ?>" class="uk-height-1-1 app-page-forgetpassword" data-base="<?php $app->base('/'); ?>" data-route="<?php $app->route('/'); ?>" data-locale="<?php echo  $app('i18n')->locale ; ?>">
<head>
    <meta charset="UTF-8">

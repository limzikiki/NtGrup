        ...
        <div class="uk-container uk-container-center">
            ...
            <div class="uk-h3 uk-flex uk-flex-middle uk-text-bold">
                <div class="uk-margin-small-right">
                    <img src="<?php echo $app->pathToUrl($singleton['icon'] ? 'assets:app/media/icons/'.$singleton['icon']:'singletons:icon.svg'); ?>" width="40" alt="icon">
                </div>
                <div class="uk-flex-item-1">{ singleton.label || singleton.name }</div>
                <?php if ($app->module('cockpit')->isSuperAdmin()) { ?>
                <a class="uk-button uk-button-outline uk-text-warning" onclick="{showDataObject}"><?php echo $app("i18n")->get('Show json'); ?></a>
                <?php } ?>
            </div>
        </div>
    ...
    <div class="uk-margin-top">
        ...
        <div class="uk-grid">
            ...
            <div class="uk-grid-margin uk-width-medium-1-4 uk-flex-order-first uk-flex-order-last-medium">
                ...
                <?php $app->trigger('singletons.form.aside', [$singleton['name']]); ?>

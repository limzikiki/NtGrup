...
<script type="riot/tag" src="<?php $app->base('collections:assets/entries-tree.tag'); ?>"></script>
...
<div class="uk-margin-top" riot-view>
    ...
    <div show="{ ready }">
        ...
        <div class="uk-clearfix uk-margin-top" show="{ !loading && (entries.length || filter) }">
            ...
            <div class="uk-float-left uk-width-1-2">
                <div class="uk-form-icon uk-form uk-width-1-1 uk-text-muted">
                    ...
                    <input class="uk-width-1-1 uk-form-large uk-form-blank {filter && filter.match(/\{(.*)\}/) && 'uk-text-monospace'}" type="text" ref="txtfilter" placeholder="<?php echo $app("i18n")->get('Filter items...'); ?>" onchange="{ updatefilter }">
        ...
        <div class="uk-margin-top" if="{(Array.isArray(entries) && entries.length) && filter}">
            ...
            <span class="uk-badge uk-badge-outline uk-text-warning uk-text-uppercase"><?php echo $app("i18n")->get('Filtered Items'); ?></span>

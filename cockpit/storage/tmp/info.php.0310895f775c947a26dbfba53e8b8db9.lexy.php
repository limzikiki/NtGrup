...
<div riot-view>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        ...
        <div class="uk-width-medium-3-4">
            ...
            <div id="settings-info" class="uk-switcher">
                ...
                <div>
                    ...
                    <h4 class="uk-text-bold"><?php echo $app("i18n")->get('Jobs queue'); ?></h4>

                    <table class="uk-table uk-table-striped">
                        <tbody>
                            <tr>
                                <td width="30%" class="uk-text-small uk-text-bold"><?php echo $app("i18n")->get('Runner active'); ?></td>
                            ...
                            <tr>
                                <td width="30%" class="uk-text-small uk-text-bold"><?php echo $app("i18n")->get('Jobs in queue'); ?></td>
                                <td class="uk-text-small"><span class="uk-text-<?php echo  !$info['jobs_queue']['cntjobs'] ? 'muted':'' ; ?>"><?php echo  $info['jobs_queue']['cntjobs'] ; ?></span></td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <script type="view/script">
            ...
            this.jobsQueue = <?php echo  json_encode($info['jobs_queue']) ; ?>;
            this.cacheSize = null;
            this.loading = false;

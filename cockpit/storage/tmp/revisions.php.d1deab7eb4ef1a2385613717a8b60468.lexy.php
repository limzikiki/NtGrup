...
<script>
  ...
  window.__singleton = <?php echo  json_encode($singleton) ; ?>;
  window.__singletonData = <?php echo  json_encode($data) ; ?>;
...
<div>
    <ul class="uk-breadcrumb">
        ...
        <li data-uk-dropdown="mode:'hover', delay:300">
            <a href="<?php $app->route('/singletons/form/'.$singleton['name']); ?>"><i class="uk-icon-bars"></i> <?php echo  htmlspecialchars(@$singleton['label'] ? $singleton['label']:$singleton['name']) ; ?></a>
        ...
        <li><span><?php echo $app("i18n")->get('Revisions'); ?></span></li>
    </ul>
</div>
    ...
    <div class="uk-width-medium-1-3 uk-viewport-height-1-2 uk-container-center uk-text-center uk-flex uk-flex-center uk-flex-middle" if="{!revisions.length}">
        <div class="uk-text-muted uk-width-1-1">
            ...
            <div class="uk-margin-large">
                <a class="uk-button uk-button-large uk-button-link" href="<?php $app->route("/singletons/form/{$singleton['name']}"); ?>"><?php echo $app("i18n")->get('Back to singleton'); ?></a>
            </div>
        </div>
    </div>
                ...
                <div class="uk-panel uk-panel-box uk-panel-card">
                    <div class="uk-flex uk-flex-middle">
                        ...
                        <div>
                            ...
                            <a class="uk-margin-left uk-button uk-button-large uk-button-link" href="<?php $app->route("/singletons/form/{$singleton['name']}"); ?>"><?php echo $app("i18n")->get('Back to singleton'); ?></a>
                        </div>
                    </div>
                </div>

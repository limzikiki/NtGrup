                    ...
                    <form id="groups-form" class="uk-form" onsubmit="{ submit }">
                        ...
                        <div class="_uk-grid-margin uk-margin-small-top">
                            ...
                            <div class="uk-width-1-1 uk-margin-top" ref="vars">
                                <?php if (isset($group['vars'])) { ?>
                                    <?php foreach ($group['vars'] as $var_key => $var_val) { ?>
                                    <div class="uk-panel uk-panel-box uk-panel-card var-row uk-margin-small-bottom">
                                        <div class="uk-grid uk-grid-small">
                                            <div class="uk-flex-item-1 uk-flex" id="group-settings-grid">
                                                <input class="__uk-width-1-4 uk-form-small" type="text" placeholder="key" value="<?php echo $var_key; ?>" >
                                                <i class="__uk-width-1-4 uk-text-center uk-icon-arrows-h"></i>
                                                <input class="__uk-width-1-4 uk-form-small" type="text" placeholder="value" value="<?php echo $var_val; ?>">
                                                <div class="__uk-width-1-4 uk-text-right">
                                                    <i class="uk-icon-trash" style="cursor: pointer" onclick="$(this).parents('.var-row').remove()"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <?php if (($info=Groups::getGroupVarInfo($var_key)) !== null) { ?>
                                            <span class="uk-icon-info group-addon-info-icon-mod" title="<?php echo $info; ?>"></span>
                                        <?php } ?>
                                    </div>
                                    <?php } ?>
                                <?php } ?>
                        ...
                        <div class="uk-margin-small-top" ref="info-table">
                            <table class="uk-table">
                                ...
                                <?php foreach (Groups::getGroupVars() as $var_key => $var_val) { ?>
                                    <tr><td><?php echo $var_key; ?></td><td><?php echo $var_val; ?></td><td><?php echo Groups::getGroupVarInfo($var_key) ?? '-'; ?></td></tr>
                                <?php } ?>
                            </table>
                        </div>

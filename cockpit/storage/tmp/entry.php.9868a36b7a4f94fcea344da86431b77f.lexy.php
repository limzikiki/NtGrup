    ...
    <div class="header-sub-panel">
        ...
        <div class="uk-container uk-container-center">
            ...
            <div class="uk-flex uk-flex-middle uk-text-bold uk-h3">
                ...
                <a onclick="{showPreview}" if="{ collection.contentpreview && collection.contentpreview.enabled }" title="<?php echo $app("i18n")->get('Preview'); ?>"><i class="uk-icon-button uk-icon-eye"></i></a>
                <?php if ($app->module('cockpit')->isSuperAdmin()) { ?>
                <div class="uk-flex-item-1"></div>
                <a class="uk-button uk-button-outline uk-text-warning" onclick="{showEntryObject}"><?php echo $app("i18n")->get('Show json'); ?></a>
                <?php } ?>
            </div>
        </div>
